/**
 * =============================================================================
 * GoogleAppsScriptAdapter — вызовы сервера из браузера
 * =============================================================================
 *
 * Вместо цепочки google.script.run.withSuccessHandler(...).функция()
 * используйте: gasAdapter.call('имяФункции', { params: [аргументы] })
 *
 * Возможности: очередь запросов, повтор при ошибке, таймаут.
 * Настройки: CONFIG.api в config.js (maxRetries, timeout, …)
 *
 * Собирается в GASAdapter.html, подключается в Index.html и Viewer.html.
 * =============================================================================
 */
